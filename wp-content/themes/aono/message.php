	...
	<div id="contact">
		<div class="wrapper-size">
			...
			<table class="message-table">
				<tr>
					<th width="20%"><?php echo (get_current_blog_id()==1)?'43282':'July 2018' ?></th>
				...
				<tr>
					<th><?php echo (get_current_blog_id()==1)?'43040':'November 2017' ?></th>
					<td><?php echo (get_current_blog_id()==1)?'ISO 9001:2015改定':'Revised ISO 9001:2015' ?></td>
				</tr>
				<tr>
					<th><?php echo (get_current_blog_id()==1)?'42979':'September 2017' ?></th>
					<td><?php echo (get_current_blog_id()==1)?'ISO 14001:2015改定':'Revised ISO 14001:2015' ?></td>
				</tr>
				<tr>
					<th><?php echo (get_current_blog_id()==1)?'42887':'June 2017' ?></th>
				...
				<tr>
					<th><?php echo (get_current_blog_id()==1)?'42614':'September 2016' ?></th>
					<td><?php echo (get_current_blog_id()==1)?'JSW　成形機350t導入':'Introduced JSW 350t molding machine' ?></td>
				</tr>
				<tr>
					<th><?php echo (get_current_blog_id()==1)?'40848':'November 2011' ?></th>
					<td><?php echo (get_current_blog_id()==1)?'創立40周年':'40th anniversary of foundation' ?></td>
				</tr>
				<tr>
					<th><?php echo (get_current_blog_id()==1)?'40148':'December 2009' ?></th>
				...
				<tr>
					<th><?php echo (get_current_blog_id()==1)?'39142':'March 2007' ?></th>
				...
				<tr>
					<th><?php echo (get_current_blog_id()==1)?'38749':'February 2006' ?></th>
					<td><?php echo (get_current_blog_id()==1)?'ISO14000　取得':'Acquired ISO14000' ?></td>
				</tr>
				<tr>
					<th><?php echo (get_current_blog_id()==1)?'38231':'September 2004' ?></th>
					<td><?php echo (get_current_blog_id()==1)?'ISO9001　取得':'Acquired ISO9001' ?></td>
				</tr>
				<tr>
					<th><?php echo (get_current_blog_id()==1)?'33848':'September 1992' ?></th>
