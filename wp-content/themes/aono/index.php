		...
		<div class="slider-area">
			<div id="sliderWrapper">
				<div class="slider-item">
					...
					<div class="slider-text"><?php echo ($_SESSION['langFlag']=='ja')?'あなたの課題に、深く寄り添う。<br />そして一歩前へ。':'Solve your problems,<br />and step forward together.' ?></div>
				</div>
				<div class="slider-item">
					<div class="slider-image image-1"></div>
					<div class="slider-text"><?php echo ($_SESSION['langFlag']=='ja')?'お困りのことありますよね？<br />"ある"という方は、弊社ウェブサイトをご覧ください。':'Do you have any problems?<br />If it\'s "Yes", please visit our website.' ?></div>
				</div>
				<div class="slider-item">
					<div class="slider-image image-2"></div>
					<div class="slider-text"><?php echo ($_SESSION['langFlag']=='ja')?'向き合って、明日をつくる青野の技術':'Aono\'s technology for the future' ?></div>
				</div>
				<div class="slider-item">
					<div class="slider-image image-3"></div>
					<div class="slider-text"><?php echo ($_SESSION['langFlag']=='ja')?'あなたの課題に、深く寄り添う。<br />そして一歩前へ。':'Solve your problems,<br />and step forward together.' ?></div>
...
<div id="contact">
	<div class="wrapper-size full">
		<h1 class="title-1"><?php echo ($_SESSION['langFlag']=='ja')?'特色':'Feature' ?></h1>
	</div>
	<div class="wrapper-size">
		<div class="advantage-area">
			<article class="center-article"><?php echo ($_SESSION['langFlag']=='ja')?
			...
			<div class="advantage-image-wrapper">
				<a href="advantage1">
					<div class="advantage-image-item">
						...
						<p>
							<i class="fa fa-chevron-right"></i>
							<span><?php echo ($_SESSION['langFlag']=='ja')?'移管型（移管金型）の成形にも対応':'Compatible with forming of transfer mold' ?></span>
						</p>
					</div>
				</a>
				<a href="advantage2">
					<div class="advantage-image-item">
						...
						<p>
							<i class="fa fa-chevron-right"></i>
							<span><?php echo ($_SESSION['langFlag']=='ja')?'金型、安価材料の提案<br />勉強会の開催':'Proposal of mold and inexpensive material<br />Holding a study group' ?></span>
						</p>
					</div>
				</a>
			</div>
	...
	<div class="wrapper-size full">
		<h1 class="title-1"><?php echo ($_SESSION['langFlag']=='ja')?'製品ギャラリー':'Product gallery' ?></h1>
	</div>
	<div class="wrapper-size">
		<div class="gallery-area">
			
			<article class="center-article"><?php echo ($_SESSION['langFlag']=='ja')?'これまで培ってきた技術を元に、IoT機器やスマートフォン、各種電池など新しい分野への挑戦を続けています。':'Based on the technology we have cultivated so far, we are continuing to challenge new fields such as IoT equipment, smart phones and various batteries.' ?></article>
			<div class="gallery-image-wrapper">
				<a href="product/#communication">
					<div class="gallery-image-item">
						...
						<p>
							<i class="fa fa-chevron-right"></i>
							<span><?php echo ($_SESSION['langFlag']=='ja')?'通信機器<br />（IoT、スマートフォン）':'Communication equipment<br />(IoT, Smartphone)' ?></span>
						</p>
					</div>
				</a>
				<a href="product/#battery">
					<div class="gallery-image-item">
						...
						<p class="mar_top25">
							<i class="fa fa-chevron-right"></i>
							<span><?php echo ($_SESSION['langFlag']=='ja')?'蓄電池':'Storage battery' ?></span>
						</p>
					</div>
				</a>
				<a href="product/#automobile">
					<div class="gallery-image-item">
						...
						<p class="mar_top25">
							<i class="fa fa-chevron-right"></i>
							<span><?php echo ($_SESSION['langFlag']=='ja')?'自動車関連':'Automobile related' ?></span>
						</p>
					</div>
				</a>
			</div>
